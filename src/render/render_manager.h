...
private:
    ...
    void renderLabelModeBatch(const float* viewMatrix, const float* projectionMatrix);
    ...
    void renderSingleObjectRGB(const float* viewMatrix,
                               const float* projectionMatrix, const float* lightPos,
                               const float* lightColor, float lightIntensity,
                               const float* camPos = nullptr);
    void renderSceneInstanceMask(const CaptureConfig& config, const float* viewMatrix,
                                 const float* projectionMatrix);
    void renderSceneInstanceMaskSingle(const CaptureConfig& config, const float* viewMatrix,
                                       const float* projectionMatrix);
